...
export default function IssueCard({ item }: IssueCardProps) {
    ...
    return (
        <div className="w-full bg-slate-200 min-h-[180px] col theme-text text-start gap-2 relative p-3 rounded-md border-2 border-black bg-opacity-40 hover:bg-opacity-80">
            <h1 className="text-sm">{item.title}</h1>
            <h2 className="text-base">By {item.user.login}</h2>
